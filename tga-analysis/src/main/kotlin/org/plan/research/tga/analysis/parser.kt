        ...
        if (file.toString().endsWith(".java")) {
            ...
            compilationUnit.findAll(ClassOrInterfaceDeclaration::class.java)
                .forEach { classDeclaration ->
                    classDeclaration.findAll(MethodDeclaration::class.java)
                        .filter { methodDeclaration -> methodDeclaration.annotations.any { it.name.identifier == "Test" } }
                        .forEach { methodDeclaration ->
                            methodDeclaration.thrownExceptions.add(StaticJavaParser.parseClassOrInterfaceType("java.lang.Throwable"))
                            methodDeclaration.findAll(TryStmt::class.java)
                                .forEach { tryStmt ->
